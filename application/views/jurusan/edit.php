...
<div class="p-6 max-w-md mx-auto">
  <div class="bg-white rounded-lg shadow p-6">
    <h2 class="text-2xl font-bold text-gray-800 mb-6 text-center">Edit Jurusan</h2>
    ...
    <?php else: ?>
      <form method="post" action="<?= base_url('jurusan/edit/' . $jurusan['id_jurusan']) ?>" class="space-y-4">
        ...
        <div class="flex items-center gap-3 mt-4">
          <button type="submit" class="w-full mt-4 rounded-lg bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600">Update</button>
        </div>
      </form>
    <?php endif; ?>
  </div>
