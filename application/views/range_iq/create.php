<div class="max-w-3xl bg-white mx-auto rounded-2xl shadow-lg overflow-hidden">
  <div class="bg-gray-600 text-white py-4 px-6">
    <h2 class="text-xl font-bold text-center">Tambah Range IQ</h2>
  </div>

  <div class="p-6">
    <form method="post" action="<?= base_url('rangeiq/add') ?>" class="space-y-6">
      ...
      <div class="flex justify-end gap-3 pt-6 border-t">
        <button type="button"
          onclick="document.getElementById('modalAddIQ').classList.add('hidden')"
