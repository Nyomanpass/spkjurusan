      ...
      <form method="post" action="<?= base_url('kriteria/tambah') ?>" class="space-y-5">
       ...
       <div>
          ...
          <select name="type_range" required
            class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-yellow-500 focus:border-transparent transition">
            <option value="" selected disabled>-- Pilih Tipe Range --</option>
            <option value="mapel">Mapel (Akademik)</option>
            <option value="prestasi">Prestasi</option>
            <option value="wawancara">Wawancara / IQ</option>
          </select>
          <p class="text-xs text-gray-500 mt-1">*Menentukan model perhitungan keterangan nilai.</p>
        </div>
